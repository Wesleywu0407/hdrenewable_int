...
Run: python -m scripts.chapter_1.fetch_rez_data
"""
...
def _fetch_arcgis_geojson(url: str, state: str, label: str) -> dict | None:
...
def _shp_zip_to_geojson(zip_bytes: bytes, state: str, label: str) -> dict | None:
