...
Run: python -m scripts.chapter_1.fetch_infrastructure_data
"""
...
from scripts.common.infrastructure import clean_datacentre_states, normalize_facility_states
...
def main() -> int:
    ...
    if templers_mask.any():
        ...
        print("  [Override] Set Templers BESS capacity to 111 MW.")
    ...
    dc_df = clean_datacentre_states(dc_df)
    ...
    bess_df = normalize_facility_states(bess_df)
    solar_df = normalize_facility_states(solar_df)
